...
describe('DashboardMetricsService', () => {
  const sampleData: DashboardDCTFRecord[] = [
    {
      ...
      businessName: 'Empresa Alpha S.A.',
      period: '05/2025',
  ...
  it('deve calcular métricas agregadas básicas', () => {
    ...
    expect(metrics.financial.balanceByIdentification[0].businessName).toBe('Empresa Alpha S.A.');
    expect(metrics.statusSummary).toEqual(
